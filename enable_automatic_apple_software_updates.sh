...
app_updates_plist="/Library/Preferences/com.apple.commerce.plist"
...
# Automatic download and install Mac Store App updates
...
/usr/bin/defaults write "$app_updates_plist" AutoUpdate -bool true
